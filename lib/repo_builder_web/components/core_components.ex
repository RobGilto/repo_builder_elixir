defmodule RepoBuilderWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: RepoBuilderWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RepoBuilderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RepoBuilderWeb.Gettext, "errors", msg, opts)
    end
  end
