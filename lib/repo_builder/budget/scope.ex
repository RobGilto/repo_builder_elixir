defmodule RepoBuilder.Budget.Scope do
  ...
  @type scope_ref ::
          {:global, String.t()} | {:orchestrator, String.t()} | {:workflow, String.t()}
  ...
  included; `:orchestrator_id`/`:workflow_run_id` (when present and non-blank) add their
  scoped refs. Accepts string or atom keys; blank/nil ids are ignored.
  """
